  ...
  Future<void> installVerifier({
    ...
    for (final serial in serials) {
      ...
      final setupCmds = <List<String>>[
        ...
        ['adb', '-s', serial, 'shell', 'cmd', 'wifi', 'connect-network', 'ELDORADO_DEVICES', 'wpa3', 'ELD@N3W2022'],
        ['adb', '-s', serial, 'shell', 'cmd', 'wifi', 'connect-network', 'ELDORADO_DEVICES', 'wpa2', 'ELD@N3W2022'],
